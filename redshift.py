...
"""
    ...
    def _server_known(cls, host, port):
        ...
        """
        with Redshift._known_servers_lock:
            return (host, port) in Redshift._known_servers
    ...
    def _set_server_known(cls, host, port):
        ...
        """
        with Redshift._known_servers_lock:
            Redshift._known_servers.add((host, port))
        ...
        for m in custom_metrics:
            ...
            try:
                for ref, (_, mtype) in iteritems(m['metrics']):
                    ...
                    m['metrics'][ref][1] = getattr(Redshift, cap_mtype)
